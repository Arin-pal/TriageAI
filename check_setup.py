    ...
    if r.status_code == 200:
        ...
        if models:
            ...
            if any("gemma" in m for m in models):
                ...
                print("    ⚠️   No Gemma model found. Run: ollama pull gemma3:4b")
        else:
            print("    ⚠️   No models downloaded yet. Run: ollama pull gemma3:4b")
    else:
...
if not cap.isOpened():
    ...
    if ret:
        ...
        print("    ⚠️   Camera opened but couldn't read a frame")
    cap.release()
